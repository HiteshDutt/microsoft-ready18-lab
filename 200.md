...
# What will you learn
- Deploy a Jenkins server and configure Jenkins for deploying a Java app to Web Apps for Containers.
...
### Generate SSH Key
    Open a terminal window on your lab Ubuntu machine
    ...
    Make note: the location for the public key is at ~/.ssh/id_ras.pub. You will need the public key during Jenkins server installation
